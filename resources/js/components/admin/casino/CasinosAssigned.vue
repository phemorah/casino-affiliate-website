      ...
      <v-container>
          <div class="row">
              <div class="col-md-3 col-sm-3 col-xs-12">
                  <v-card outlined>
                      <v-card-title>Casinos</v-card-title>
                      <v-divider></v-divider>
                      <template>
                        <v-btn
                            @click="() => {
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                  ...
                  <div class="row text-center">
                      <div class="col-md-3 col-sm-6 col-xs-12" v-for="country in casino.countries" :key="country.id">
                          <v-hover v-slot:default="{ hover }">
                              ...
                              >
                                ...
                                <v-card-text class="text--primary" style="margin-bottom:-8px">Casino Name</v-card-text>
